    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalShowLabel{{ $item->id }}">Detail Galeri: {{ $item->namaFile }}</h5>
            ...
            <div class="modal-body text-center">
                ...
                <img src="{{ asset('storage/uploads/galeri/' . $item->file) }}" alt="Galeri"
                    class="img-fluid img-thumbnail" style="max-width: 100%; height: auto;">
            </div>
            <div class="modal-footer">
                <a href="{{ route('admin.galeri.download', $item->id) }}" class="btn btn-success"><i
