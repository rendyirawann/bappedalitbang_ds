...
<div class="nav-master-container">
    ...
    <div class="menu-side-wrapper" id="menuTarget">
        <ul class="nav-list-main">
            <li><a href="{{ route('home') }}" class="nav-item-link">Beranda</a></li>
            <li class="dropdown" id="dropdownProfile">
                ...
                <div class="dropdown-menu-custom">
                    <a href="{{ url('visimisi') }}" class="dropdown-item-custom">Visi & Misi</a>
                    <a href="{{ url('struktur') }}" class="dropdown-item-custom">Struktur Organisasi</a>
                    <a href="{{ url('unduhan') }}" class="dropdown-item-custom">Unduhan</a>
                </div>
            </li>
            <li><a href="{{ url('berita') }}" class="nav-item-link">Berita</a></li>
            <li><a href="{{ url('galeri') }}" class="nav-item-link">Galeri</a></li>
        </ul>
    </div>
</div>
