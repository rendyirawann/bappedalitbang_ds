...
use backend\models\search\TblIndividu2022Search;
...
/**
 * TblIndividu2022Controller implements the CRUD actions for TblIndividu2022 model.
 */
class TblIndividu2022Controller extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    /**
     * Lists all TblIndividu2022 models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new TblIndividu2022Search();
    ...
    /**
     * Displays a single TblIndividu2022 model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new TblIndividu2022 model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new TblIndividu2022();
    ...
    /**
     * Updates an existing TblIndividu2022 model.
...
{
    $model = new UploadFormIndividu2022();
    ...
    if (Yii::$app->request->isPost) {
        ...
        if ($filePath) {
            ...
            foreach ($rows as $index => $row) {
                ...
                $individu->kecamatan = !empty($row[3]) ? $row[3] : null; // Column 3
                $individu->jumlah = (int)$row[4]; // Column 4
                $individu->anggaran = !empty($row[5]) ? $row[5] : null; // Column 5
                $individu->keterangan = !empty($row[6]) ? $row[6] : null; // Column 6
...
{
    $models = TblIndividu2022::find()->all();
...
public function actionExportXlsx()
{
    ...
    /**
     * Deletes an existing TblIndividu2022 model.
    ...
    /**
     * Finds the TblIndividu2022 model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return TblIndividu2022 the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TblIndividu2022::findOne(['id' => $id])) !== null) {
            return $model;
        }
