...
class DataIpald extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['kodeAset'], 'exist', 'skipOnError' => true, 'targetClass' => AsetIpald::class, 'targetAttribute' => ['kodeAset' => 'namaAset']],
            [['kodeBidang'], 'exist', 'skipOnError' => true, 'targetClass' => BidangIpald::class, 'targetAttribute' => ['kodeBidang' => 'namaBidang']],
            [['kodeDana'], 'exist', 'skipOnError' => true, 'targetClass' => DanaIpald::class, 'targetAttribute' => ['kodeDana' => 'sumberDana']],
            [['kodeKecamatan'], 'exist', 'skipOnError' => true, 'targetClass' => DataKecamatan::class, 'targetAttribute' => ['kodeKecamatan' => 'namaKecamatan']],
            [['kodeDesa'], 'exist', 'skipOnError' => true, 'targetClass' => DataDesa::class, 'targetAttribute' => ['kodeDesa' => 'namaDesa']],
            [['kodePengelola'], 'exist', 'skipOnError' => true, 'targetClass' => DataPengelola::class, 'targetAttribute' => ['kodePengelola' => 'namaPengelola']],
            [['kodeStatus'], 'exist', 'skipOnError' => true, 'targetClass' => StatusAset::class, 'targetAttribute' => ['kodeStatus' => 'namaStatus']],
