      ...
      <div class="footer-wrapper container-fluid">
        <div class="row">
          <div class="col-sm-6 my-1">
            <p class="m-0">Copyright &copy; 2024. Bidang Infrastruktur dan Kewilayahan <a href="https://bappedalitbang.deliserdangkab.go.id/" target="_blank"> Bappedalitbang Deli Serdang</a></p>
          </div>
          <div class="col-sm-6 ms-auto my-1">
            <ul class="list-inline footer-link mb-0 justify-content-sm-end d-flex">
              <li class="list-inline-item">Version APP BETA</li>
...
<script>
  ...
  })({ key: "AIzaSyCffYv72gX32WEm2c0wC-FaphNARKwSm1I", v: "weekly" });
</script>
...
<script
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCffYv72gX32WEm2c0wC-FaphNARKwSm1I&callback=initMap&v=weekly"
  defer>
</script>
...
<script>
  ...
  async function initMap() {
    ...
    maps = new Map(document.getElementById("maps"), {
      center: { lat: 3.5482456257070925, lng: 98.86596412667134},
      zoom: 15,
    });
  }
