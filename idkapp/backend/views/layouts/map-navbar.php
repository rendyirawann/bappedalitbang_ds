  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="<?= Url::to(['/site/index']) ?>" class="b-brand text-primary">
        ...
        <h5><img src="<?= Url::base(true)?>/lightapp/assets/images/bappeda.png" alt="logo image" height="60" width="60" class="logo-lg" />IPALD<span class="badge bg-brand-color-2 rounded-pill ms-2 theme-version">vBETA</span></h5>
      ...
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="<?= Url::to(['/site/index']) ?>" class="pc-link">
            ...
            <span class="pc-arrow"><i class="fas fa-arrow-alt-circle-left" style="color:red;"></i></span>
            <span class="pc-mtext">Back to Dashboard</span>
        ...
        <li class="pc-item pc-hasmenu">
          <a href="<?= Url::to(['/map/index']) ?>" class="pc-link">
            ...
            <span class="pc-mtext">Index</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
            <!-- <span class="pc-badge">2</span> -->
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="<?= Url::to(['/map/marker']) ?>" class="pc-link">
            <span class="pc-micon">
              <i class="fas fa-map-marker-alt"></i>
            </span>
            <span class="pc-mtext">Marker</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
            <!-- <span class="pc-badge">2</span> -->
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="<?= Url::to(['/map/polyline']) ?>" class="pc-link">
            <span class="pc-micon">
              <i class="fas fa-map-pin"></i>
            </span>
            <span class="pc-mtext">Marker Polyline</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
            <!-- <span class="pc-badge">2</span> -->
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="<?= Url::to(['/map/route']) ?>" class="pc-link">
            <span class="pc-micon">
              <i class="fas fa-map-marked-alt"></i>
            </span>
            <span class="pc-mtext">Route</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
            <!-- <span class="pc-badge">2</span> -->
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="<?= Url::to(['/map/circle']) ?>" class="pc-link">
            <span class="pc-micon">
              <i class="fas fa-circle-notch"></i>
            </span>
            <span class="pc-mtext">Circle</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
            <!-- <span class="pc-badge">2</span> -->
          </a>
        </li>
        <li class="pc-item pc-hasmenu">
          <a href="<?= Url::to(['/map/draw']) ?>" class="pc-link">
            <span class="pc-micon">
              <i class="fas fa-paint-brush"></i>
            </span>
            <span class="pc-mtext">Draw Leaflet Map</span>
            <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
            <!-- <span class="pc-badge">2</span> -->
          </a>
        </li>
