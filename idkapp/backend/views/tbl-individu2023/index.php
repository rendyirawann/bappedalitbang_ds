...
/** @var backend\models\search\TblIndividu2023 $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Individu 2023';
      ...
      <div class="pc-content">
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <?php endif; ?>
            <?= Html::a('Create Tbl Individu 2023', ['create'], ['class' => 'btn btn-success']) ?>
                  ...
                  <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap">
                    ...
                    <?php $no = 1; ?>
                      ...
                      <tr>
                        ...
                        <td><?= Html::encode($model->kode_kegiatan) ?></td>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Data Individu 2023</h5>
                </div>
