...
$this->title = 'View Data IPALD - ' . $model->fasilitas;
    ...
    <div class="pc-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h1>View Data IPALD - <?= Html::encode($model->id) ?></h1>
                        ...
                        <p>
                            ...
                            <?= Html::a('Tambah Gambar', ['ipald-dokumen/create', 'kodeDataIpald' => $model->id], ['class' => 'btn btn-success']) ?>
                            ...
                            <div class="row">
                                <?php foreach ($ipaldDokumens as $ipaldDokumen) : ?>
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                                        <div class="thumbnail">
                                            <?= Html::a(
                                                Html::img('@web/dokumen/data_ipald_image/' . $ipaldDokumen->file, [
                                                    'style' => 'width: 100%; height: 200px; object-fit: cover;'
                                                ]),
                                                '@web/dokumen/data_ipald_image/' . $ipaldDokumen->file,
                                                ['data-lightbox' => 'ipald-dokumen', 'data-title' => $model->fasilitas]
                                            )
                                            ?>
                                            <?= Html::a(
                                                '<i class="fa fa-download"></i>',
                                                ['ipald-dokumen/download', 'id' => $ipaldDokumen->id],
                                                [
                                                    'class' => 'btn btn-success btn-sm mr-2',
                                                    'title' => 'Download',
                                                ]
                                            ) ?>
                                            <?= Html::a('<i class="fa fa-trash"></i>', ['ipald-dokumen/delete', 'id' => $ipaldDokumen->id], [
                        ...
                        ?>
                            ...
                            <?= Html::a('Tambah Gambar', ['ipald-dokumen/create', 'kodeDataIpald' => $model->id], ['class' => 'btn btn-success mt-3']) ?>
                        <?php } ?>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="createModalLabel">Tambah Data IPALD</h5>
