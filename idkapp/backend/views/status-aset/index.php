...
/** @var backend\models\search\StatusAsetSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Status Aset';
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Data Status Asets</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Data Status Aset</h2>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap">
                    ...
                    <?php $no = 1; ?>
                      ...
                      <tr>
                        ...
                        <td><?= Html::encode($model->namaStatus) ?></td>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Data Status Aset</h5>
                </div>
