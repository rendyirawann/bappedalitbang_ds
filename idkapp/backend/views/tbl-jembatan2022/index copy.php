...
/** @var backend\models\search\TblJembatan2022Search $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Jembatan 2022';
      ...
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Data Jembatan 2022</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Data Jembatan 2022</h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <?php endif; ?>
              <?= Html::a('Create Tbl Jembatan 2023', ['create'], ['class' => 'btn btn-success']) ?>
        ...
        <?= Html::a('Export to XLSX', ['export-xlsx'], ['class' => 'btn btn-primary']) ?>
                <table id="res-config" class="display table table-striped table-hover dt-responsive nowrap mt-2" style="width: 100%">
                  <thead>
                    <tr>
                    <th>No</th>
                    <th>Nama Pekerjaan</th>
                    <th>Keterangan</th>
                    <th>Realisasi Meter</th>
                    <th>Action</th>
                    </tr>
                  </thead>
                  <tbody>
                  ...
                  <?php $no = 1; ?>
                    ...
                    <tr>
                      ...
                      <td><?= Html::encode($model->namaPekerjaan) ?></td>
                      <td><?= Html::encode($model->keterangan) ?></td>
                      <td><?= Html::encode($model->realisasi_meter) ?></td>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Data Jembatan 2022</h5>
                </div>
