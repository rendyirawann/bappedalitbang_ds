...
/** @var backend\models\search\InstansiSearch $searchModel */
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Data Instansi</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <?= Html::button('Tambah Data Instansi', [
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($dataProvider->models as $model) : ?>
                                        <tr>
                                            ...
                                            <td><?= Html::encode($model->kode_skpd) ?></td>
                                            <td><?= Html::encode($model->instansi) ?></td>
                                ...
                                <div class="modal-dialog modal-xl" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Detail Data Instansi</h5>
                                        </div>
