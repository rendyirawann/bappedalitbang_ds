...
/** @var backend\models\search\TblIndividu2021Search $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Tbl Individu2021s';
      ...
      <div class="pc-content">
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <?php endif; ?>
            <?= Html::a('Create Tbl Individu 2021', ['create'], ['class' => 'btn btn-success']) ?>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Data Individu 2021</h5>
                </div>
