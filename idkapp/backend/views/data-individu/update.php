...
$this->title = 'Update Data Septic Tank Individu: ' . $model->id;
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Update Data Septic Tank Individu</li>
            </ul>
          </div>
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="mb-0">Update Data Septic Tank Individu</h2>
            </div>
          </div>
        </div>
      </div>
