...
$this->title = 'View Data Septic Tank Individu - ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => 'Data Individus', 'url' => ['index']];
  ...
  <div class="pc-content">
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">View Data Septic Tank Individu</li>
            </ul>
          </div>
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="mb-0">View Data Septic Tank Individu</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            <h1>View Data Septic Tank Individu - <?= Html::encode($model->id) ?></h1>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="createModalLabel">Tambah Data Individu</h5>
