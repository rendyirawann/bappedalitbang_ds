...
$this->title = 'View Data Aset IPALD - ' . $model->namaAset;
      ...
      <div class="pc-content">
          ...
          <div class="page-block">
            <div class="row align-items-center">
              ...
              <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">View Data Aset IPALD</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">View Data Aset IPALD</h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
              <h1>View Data Aset IPALD - <?= Html::encode($model->id) ?></h1>
