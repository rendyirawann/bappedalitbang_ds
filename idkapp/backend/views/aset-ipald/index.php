...
/** @var backend\models\search\AsetIpaldSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Aset IPALD';
      ...
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Data Aset IPALD</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Data Aset IPALD</h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <?php endif; ?>
            <?= Html::a('Tambah Aset IPALD', ['create'], ['class' => 'btn btn-success']) ?>
                <div class="dt-responsive table-responsive">
                  <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap">
                    <thead>
                    <tr>
                    <th>No</th>
                    <th>Nama Aset IPALD</th>
                    <th>Action</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <?php $no = 1; ?>
                      ...
                      <tr>
                        ...
                        <td><?= Html::encode($model->namaAset) ?></td>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Aset IPALD</h5>
                </div>
