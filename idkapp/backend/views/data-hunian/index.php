...
/** @var backend\models\search\DataHunianSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Hunian';
$this->params['breadcrumbs'][] = $this->title;
$this->registerJs("
    $('#createModal').on('show.bs.modal', function (event) {
        var modal = $(this);
        $.ajax({
            url: '" . Url::to(['data-hunian/create']) . "',
            type: 'GET',
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Data Hunian</li>
            </ul>
          </div>
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="mb-0">Data Hunian</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php endif; ?>
            <?= Html::button('Tambah Data Hunian', [
              'class' => 'btn btn-success',
              'data-bs-toggle' => 'modal',
              'data-bs-target' => '#createModal',
            ]) ?>
            <?= Html::a('Upload CSV to Database', ['upload'], ['class' => 'btn btn-success']) ?>
            <!-- <?= Html::a('List Marker', ['marker'], ['class' => 'btn btn-success']) ?>
            <?= Html::a('All Datas', ['marker-all'], ['class' => 'btn btn-success']) ?> -->
                ...
                <tbody>
                  ...
                  <?php foreach ($dataProvider->models as $model) : ?>
                    <tr>
                      ...
                      <td><?= Html::encode($model->namaPemohon) ?></td>
                      <td><?= Html::encode($model->lokasiBangunan) ?></td>
                      <td><?= Html::encode($model->kodeKecamatan) ?></td>
                ...
                <div class="modal-dialog modal-xl" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Detail Data Hunian</h5>
                    </div>
            ...
            <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="createModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="createModalLabel">Tambah Data Hunian</h5>
