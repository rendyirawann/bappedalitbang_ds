...
/** @var backend\models\search\BidangIpaldSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Bidang yang Kelola IPALD';
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Data Bidang yang Kelola IPALD</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Data Bidang yang Kelola IPALD</h2>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Data Bidang yang Kelola IPALD</h5>
                <small
                  >List Data</small
                >
              </div>
            ...
            <?= Html::a('Tambah Bidang', ['create'], ['class' => 'btn btn-success']) ?>
                <div class="dt-responsive table-responsive">
                  <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap">
                    ...
                    <tr>
                    <th>No</th>
                    <th>Nama Bidang yang Kelola IPALD</th>
                    <th>Action</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <?php $no = 1; ?>
                      ...
                      <tr>
                        ...
                        <td><?= Html::encode($model->namaBidang) ?></td>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Bidang yang Kelola IPALD</h5>
                </div>
