...
$this->title = 'Update Bidang Ipald: ' . $model->id;
          ...
          <div class="page-block">
            <div class="row align-items-center">
              ...
              <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Tambah Bidang</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Tambah Bidang</h2>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header">
                <h5>Form Bidang yang Kelola IPALD</h5>
              </div>
              <div class="card-body">
              <?= $this->render('_form', [
                'model' => $model,
