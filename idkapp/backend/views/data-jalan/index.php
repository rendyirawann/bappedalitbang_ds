...
/** @var backend\models\search\DataJalanSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Data Jalan';
      ...
      <div class="pc-content">
            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Data Jalan</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Data Jalan</h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <?php endif; ?>
            <?= Html::a('Tambah Jalan', ['create'], ['class' => 'btn btn-success']) ?>
                  ...
                  <table id="table-style-hover" class="table table-striped table-hover table-bordered nowrap">
                    ...
                    <?php $no = 1; ?>
                      ...
                      <tr>
                        ...
                        <td><?= Html::encode($model->namaJalan) ?></td>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Jalan</h5>
                </div>
