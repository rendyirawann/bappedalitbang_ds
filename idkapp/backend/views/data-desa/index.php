...
/** @var backend\models\search\DataDesaSearch $searchModel */
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page">Data Desa</li>
            </ul>
          </div>
          <div class="col-md-12">
            <div class="page-header-title">
              <h2 class="mb-0">Data Desa</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?= Html::a('<i class="fa fa-print"></i>Cetak', ['print-all', 'data' => 'current'], ['class' => 'btn btn-outline-success', 'id' => 'print-button', 'target' => '_blank']) ?>
                ...
                <tbody>
                  ...
                  <?php foreach ($dataProvider->models as $model) : ?>
                    <tr>
                      ...
                      <td><?= Html::encode($model->namaDesa) ?></td>
                      <td><?= Html::encode($model->idKecamatan) ?></td>
