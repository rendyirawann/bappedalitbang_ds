...
/** @var backend\models\search\IrigasiSaluran $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Irigasi Salurans';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Data Irigasi Saluran</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Data Irigasi Saluran</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <?= Html::button('Tambah Data Irigasi Saluran', [
                                ...
                                <div class="modal-dialog modal-xxl" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Detail Data Irigasi Saluran</h5>
                                        </div>
