...
$this->title = 'Update Irigasi Saluran: ' . $model->id;
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Update Data Irigasi Saluran</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Update Data Irigasi Saluran</h2>
                        </div>
                    </div>
                </div>
            </div>
