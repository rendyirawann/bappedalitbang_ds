...
$this->title = 'Tambah Irigasi Bangunan';
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Tambah Data Irigasi Bangunan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Tambah Data Irigasi Bangunan</h2>
                        </div>
                    </div>
                </div>
            </div>
