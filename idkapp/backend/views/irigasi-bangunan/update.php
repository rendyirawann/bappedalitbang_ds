...
$this->title = 'Update Irigasi Bangunan: ' . $model->id;
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Update Data Irigasi Bangunan</li>
                        </ul>
                    </div>
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">Update Data Irigasi Bangunan</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>Form Data Irigasi Bangunan</h5>
                    </div>
                    <div class="card-body">
