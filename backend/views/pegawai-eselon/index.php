...
/** @var backend\models\search\PegawaiEselonSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Kategori Eselon';
...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Kategori Eselon</li>
      </ol>
		<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Kategori Eselon</div>
        <div class="card-body">
        <?php if (Yii::$app->session->hasFlash('success')): ?>
          ...
          <?php endif; ?>
        <p>
        <?= Html::a('Tambah Kategori Eselon', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <?php foreach ($dataProvider->models as $model): ?>
                <tr>
                    ...
                    <td><?= Html::encode($model->nm_eselon) ?></td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Kategori Eselon</h5>
