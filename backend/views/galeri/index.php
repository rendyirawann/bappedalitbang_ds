...
/** @var backend\models\search\GaleriSearch $searchModel */
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Galeri Kegiatan</div>
        <div class="card-body">
        <?php if (Yii::$app->session->hasFlash('success')): ?>
          ...
          <?php endif; ?>
        <p>
        <?= Html::a('Tambah Galeri Kegiatan', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
