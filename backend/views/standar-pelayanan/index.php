...
/** @var backend\models\search\StandarPelayananSearch $searchModel */
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Standar Pelayanan</div>
        <div class="card-body">
        <?php if (Yii::$app->session->hasFlash('success')): ?>
          ...
          <?php endif; ?>
        <p>
        <?= Html::a('Tambah Standar Pelayanan', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Standar Pelayanan</h5>
