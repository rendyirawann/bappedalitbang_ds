...
/** @var backend\models\search\UnduhanSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Berkas Unduhan';
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> Data Berkas Unduhan
            </div>
            <div class="card-body">
                ...
                <?php endif; ?>
                <p>
                    <?= Html::a('Tambah Berkas Unduhan', ['create'], ['class' => 'btn btn-success']) ?>
                </p>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($dataProvider->models as $model): ?>
                                <tr>
                                    ...
                                    <td><?= Html::encode($model->bidang?->bidang ?? 'Tidak ada bidang') ?></td>
