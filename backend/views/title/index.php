...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Title Jabatan</li>
      </ol>
		<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Title Jabatan</div>
        <div class="card-body">
        <?php if (Yii::$app->session->hasFlash('success')): ?>
          ...
          <?php endif; ?>
        <p>
        <?= Html::a('Tambah Title Jabatan', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Title Jabatan</h5>
