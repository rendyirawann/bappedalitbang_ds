...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">View Struktur Anggota</li>
      </ol>
		<!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header"><h1>Detail Struktur Anggota - <?= Html::encode($this->title) ?></h1></div>
        <div class="card-body">
