...
/** @var backend\models\search\StrukturSearch $searchModel */
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Struktur Anggota</div>
        <div class="card-body">
        ...
        <p>
        <?= Html::a('Tambah Struktur Anggota', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
<?php endif; ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detail Struktur</h5>
